...
def check_git_repo_status(work_path):
    logger.info('获取当前目录:' + os.path.abspath(os.path.dirname(__file__)))
    exec_cmd = ['git', 'status']
    logger.info('开始检查git工作区状态...')
